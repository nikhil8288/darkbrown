...
CARDS = [
    ...
    _dt_card("Active Tenants", "Tenancy Agreement",
             [["Tenancy Agreement", "status", "=", "Active"]]),
    _dt_card("New Agreements This Month", "Tenancy Agreement",
             [["Tenancy Agreement", "creation", "Timespan",
               "this month"]]),
    _dt_card("Ending This Month", "Tenancy Agreement",
             [["Tenancy Agreement", "end_date", "Timespan",
               "this month"]]),
    ...
    _dt_card("PDC Incoming This Week", "Cheque",
             [["Cheque", "direction", "=", "Incoming"],
              ["Cheque", "cheque_date", "Timespan", "next week"]]),
    _dt_card("PDC Outgoing This Week", "Cheque",
    ...
    _dt_card("Draft Tenant Agreements", "Tenancy Agreement",
             [["Tenancy Agreement", "workflow_state", "=", "Draft"]]),
    _dt_card("Draft Head Leases", "Head Lease",
             [["Head Lease", "workflow_state", "=", "Draft"]]),
...
WORKSPACES = {
    "DBR Finance": {
        ...
        "ncards": {
            ...
            "Cheques": ["PDC Incoming This Week",
                            "PDC Outgoing This Week"],
        },
        "shortcuts": ["Sales Invoice", "Purchase Invoice",
                      "Payment Entry", "Journal Entry", "Cheque",
                      "Collection Case"],
        "charts": [],
    ...
    "GM Overview": {
        ...
        "shortcuts": ["Tenancy Agreement", "Customer", "Unit",
    ...
    "Legal Docs": {
        "icon": "legal",
        "roles": ["Documentation", "Managing Director"],
        "sequence_id": 32.0,
        "ncards": {
        ...
        "shortcuts": ["Document Register", "Tenancy Agreement",
                      "Head Lease", "Building", "Customer",
                      "Supplier"],
